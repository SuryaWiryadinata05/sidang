...
<head>
    ...
    <link rel="stylesheet" href="ihh/assets/css/flaticon.css">
    <link rel="stylesheet" href="ihh/assets/css/progressbar_barfiller.css">
    <link rel="stylesheet" href="ihh/assets/css/gijgo.css">
    <link rel="stylesheet" href="ihh/assets/css/animate.min.css">
    <link rel="stylesheet" href="ihh/assets/css/animated-headline.css">
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-2">
                                <div class="logo">
                                    <a href="index.html"><img src="kamuaku/images/logo-custom.png" width="200px" height="70" alt=""></a>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-12">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInLeft" data-delay="0.2s">Situs web<br>Absensi</h1>
                                    <p data-animation="fadeInLeft" data-delay="0.4s">Mudah Digunakan Dan Cepat</p>
                                    <p data-animation="fadeInLeft" data-delay="0.4s">Pokonyamah Gaskeunss Buakaaarrrrr</p>
                                </div>
                            </div>
                        </div>
                    </div>          
            ...
            <div class="container">
                <div class="row justify-content-sm-center">
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="single-services mb-30">
                            <div class="features-icon">
                                <img src="ihh/assets/img/icon/icon1.svg" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="single-services mb-30">
                            <div class="features-icon">
                                <img src="ihh/assets/img/icon/icon2.svg" alt="">
                            </div>
                            <div class="features-caption">
                                <h3>Proses</h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="single-services mb-30">
                            <div class="features-icon">
                                <img src="ihh/assets/img/icon/icon3.svg" alt="">
                            </div>
                            <div class="features-caption">
                                <h3>Efisien</h3>
            ...
            <div class="container">
                ...
                <div class="team-active">
                    <div class="single-cat text-center">
                        <div class="cat-icon">
                            <img src="ihh/assets/img/gallery/kiki.jfif" width="194px" height="190px" style="border-radius: 128px; border: 12px solid #efefef;" alt="">
                        </div>
                        <div class="cat-cap">
                            <h5><a href="services.html">Mr. Kiki</a></h5>
                            <p>Rekayasa Perangkat lunak XII Rpl 2</p>
                        </div>
                    </div>
                    <div class="single-cat text-center">
                        <div class="cat-icon">
                            <img src="ihh/assets/img/gallery/sur.jfif" width="194px" height="190px" style="border-radius: 128px; border: 12px solid #efefef;" alt="">
                        </div>
                        <div class="cat-cap">
                    ...
                    <div class="single-cat text-center">
                        <div class="cat-icon">
                            <img src="ihh/assets/img/gallery/nadd.jfif" width="194px" height="190px" style="border-radius: 128px; border: 12px solid #efefef;" alt="">
                        </div>
                        <div class="cat-cap">
                            <h5><a href="services.html">Mr.s Nadd</a></h5>
                            <p>Rekayasa Perangkat lunak XII Rpl 3</p>
                        </div>
                    </div>
                </div>
...
<!-- Progress -->
<script src="ihh/assets/js/jquery.barfiller.js"></script>
